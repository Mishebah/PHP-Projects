...
//       'downloadAction' => 'gridview/export/download',
    ...
    'components' => [
            ...
            'cookieValidationKey' => 'gBtcPI-IWjwssdfadfabQO6ulci3%3ssqfeafdwww-j7y',
                         'csrfParam' => '_mm_content-frontend',
                         'parsers' => [
        ...
        'user' => [
            ...
            'enableAutoLogin' => true,
                         'identityCookie' => ['name' => 'mm_content_identity-frontend', 'httpOnly' => true],
        ],
        'session' => [
        ...
        'as beforeRequest' =>
            [
                ...
                'rules' =>  [
                                [
                                     'actions' => ['login','inbox','validation','captcha','contact','terms', 'signup','error','passwordreset','index','activate','reset-password','setpassword','set-password'],
                                     'allow' => true,
                                ],
                                [
                                    'allow' => true,
