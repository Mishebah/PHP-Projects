...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2019 at 10:44 AM
...
(1, 'Test', 'test this ois ok', 'sdfa342', 1, 1, '2018-07-23 00:00:00', '2018-07-25 00:00:00', 1, 0, 0, 1, '0000-00-00 00:00:00', 0, '2018-11-04 10:13:58'),
(2, 'Test', 'test this ois ok', '523wew', 1, 1, '2018-07-23 00:00:00', '2018-07-25 00:00:00', 1, 0, 0, 1, '0000-00-00 00:00:00', 0, '2018-11-04 10:14:02'),
(3, 'Dr IQ', 'afda', '2343wewer', 2, 1, '2018-08-01 00:00:00', '2018-08-12 00:00:00', 1, 0, 0, 1, '2018-08-09 12:19:56', 1, '2018-11-04 10:14:05'),
(4, 'adfadfadsssss', '', '895e24de3261d', 0, 1, '2019-12-12 00:00:00', '2020-02-12 00:00:00', 0, 0, 0, 1, '2018-11-09 13:22:30', 1, '2018-11-09 12:25:32'),
(5, 'test campaign as three', '', 'd9b926b3459e0', 0, 1, '2018-01-12 00:00:00', '2000-01-20 00:00:00', 0, 0, 0, 1, '2018-11-09 13:28:17', 1, '2018-11-09 10:28:17'),
(6, 'This is a good one', 'This is a good one', 'd3d3d25e7c782', 0, 1, '2019-02-13 11:00:00', '2019-02-22 11:00:00', 1, 0, 0, 1, '2019-02-13 09:45:27', 1, '2019-02-13 06:45:27'),
(7, 'Winacarruffle', 'Winacarruffle', 'a7486e4e2d90a', 0, 1, '2019-03-01 17:00:00', '2019-04-06 17:00:00', 1, 0, 0, 1, '2019-03-01 15:32:38', 1, '2019-03-01 12:32:38'),
(8, 'Alfred test', 'Alfred test', '5fc07f233e6e8', 0, 1, '2019-03-14 11:00:00', '2019-03-30 11:00:00', 1, 0, 0, 1, '2019-03-13 09:24:31', 1, '2019-03-13 06:24:31');

-- --------------------------------------------------------

--
-- Table structure for table `campaignRequests`
--

CREATE TABLE `campaignRequests` (
...
CREATE TABLE `cCodes` (
  ...
  `cHasDigits` tinyint(4) NOT NULL DEFAULT '0',
  `cHasUpperCase` tinyint(4) NOT NULL DEFAULT '0',
  `cHasLowerCase` tinyint(4) NOT NULL DEFAULT '0',
  `cLength` int(11) NOT NULL,
  `cPrefix` varchar(5) NOT NULL,
  `cSuffix` varchar(5) NOT NULL,
...
--
-- Table structure for table `raffleEntries`
--
...
CREATE TABLE `raffleEntries` (
  ...
  `ticketIssued` varchar(50) NOT NULL,
  `extradata` text,
  `status` tinyint(4) NOT NULL DEFAULT '1',
  `campaignID` int(10) UNSIGNED NOT NULL,
  `clientID` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `raffleOrders`
--
...
CREATE TABLE `raffleOrders` (
  ...
  `attendeeMobileNumber` bigint(15) NOT NULL,
...
--
-- Table structure for table `raffleOrderTickets`
--

CREATE TABLE `raffleOrderTickets` (
  `orderTicketID` int(11) UNSIGNED NOT NULL,
  `clientID` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `campaignID` int(10) UNSIGNED NOT NULL,
  ...
  `ticketQuantity` int(11) NOT NULL DEFAULT '0',
  `ticketPrice` int(11) NOT NULL,
  `ticketNumber` varchar(100) DEFAULT NULL,
  `ticketAttendeeName` varchar(100) NOT NULL,
  `ticketAttendeeEmail` varchar(100) NOT NULL,
  `ticketAttendeeMobileNumber` bigint(15) NOT NULL,
  `status` smallint(3) NOT NULL DEFAULT '1',
  `dateCreated` datetime NOT NULL,
  `dateModified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `insertedBy` int(11) UNSIGNED DEFAULT NULL,
...
ALTER TABLE `campaign`
  ...
  ADD KEY `broadcastStatusID` (`status`),
  ADD KEY `broadcasts_sentTime` (`startDate`),
...
--
-- Indexes for table `raffleEntries`
--
ALTER TABLE `raffleEntries`
  ADD PRIMARY KEY (`entryID`),
  ADD KEY `clientID` (`clientID`),
  ADD KEY `campaignID` (`campaignID`);

--
-- Indexes for table `raffleOrders`
--
ALTER TABLE `raffleOrders`
  ADD PRIMARY KEY (`orderID`),
  ADD UNIQUE KEY `orderNo` (`orderNo`),
  ADD KEY `fk_payments_clients1_idx` (`clientID`),
  ADD KEY `amountPaid` (`amountPaid`),
  ADD KEY `overallStatus` (`status`),
  ADD KEY `fk_cPayments_insertedBy` (`insertedBy`),
  ADD KEY `fk_cPayments_updatedBy` (`updatedBy`),
  ADD KEY `campaignID` (`campaignID`);

--
-- Indexes for table `raffleOrderTickets`
--
ALTER TABLE `raffleOrderTickets`
  ADD PRIMARY KEY (`orderTicketID`),
  ADD KEY `fk_payments_clients1_idx` (`clientID`),
  ADD KEY `overallStatus` (`status`),
  ADD KEY `fk_cPayments_insertedBy` (`insertedBy`),
  ADD KEY `fk_cPayments_updatedBy` (`updatedBy`),
...
--
ALTER TABLE `campaign`
  MODIFY `campaignID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `campaignRequests`
--
ALTER TABLE `campaignRequests`
  MODIFY `requestsID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `confirmation`
  MODIFY `requestsID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT for table `creditConsumption`
--
ALTER TABLE `creditConsumption`
  MODIFY `consumptionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `cRules`
--
ALTER TABLE `cRules`
  MODIFY `ruleID` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cSettings`
--
ALTER TABLE `cSettings`
...
--
ALTER TABLE `emailQueue`
  MODIFY `emailQueueID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `groups`
--
ALTER TABLE `groups`
  MODIFY `groupID` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `mnemonics`
--
ALTER TABLE `mnemonics`
  MODIFY `mnemonicID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `outbound`
--
ALTER TABLE `outbound`
  MODIFY `outboundID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `outMessages`
--
ALTER TABLE `outMessages`
  MODIFY `messageID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=697;

--
-- AUTO_INCREMENT for table `protocols`
--
ALTER TABLE `protocols`
  MODIFY `protocolID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `raffleEntries`
--
ALTER TABLE `raffleEntries`
  MODIFY `entryID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `raffleOrders`
--
ALTER TABLE `raffleOrders`
  MODIFY `orderID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `raffleOrderTickets`
--
ALTER TABLE `raffleOrderTickets`
  MODIFY `orderTicketID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `reports`
--
ALTER TABLE `reports`
  MODIFY `reportID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `reportTypes`
--
ALTER TABLE `reportTypes`
  MODIFY `reportTypeID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `rPaymentSettings`
--
ALTER TABLE `rPaymentSettings`
  MODIFY `rSettingID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `sourceAddresses`
--
ALTER TABLE `sourceAddresses`
  MODIFY `sourceAddressID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;

--
-- AUTO_INCREMENT for table `statusCodes`
--
ALTER TABLE `statusCodes`
  MODIFY `statusCodeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `transactions`
--
ALTER TABLE `transactions`
  MODIFY `transactionID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `transactionStatus`
--
ALTER TABLE `transactionStatus`
  MODIFY `transactionStatusID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;

--
-- AUTO_INCREMENT for table `transactionTypes`
--
ALTER TABLE `transactionTypes`
  MODIFY `transactionTypeID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `userPasswordRequest`
--
ALTER TABLE `userPasswordRequest`
...
--
-- AUTO_INCREMENT for table `vList`
--
ALTER TABLE `vList`
  MODIFY `vListID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vListActions`
--
ALTER TABLE `vListActions`
  MODIFY `permissionID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vListEntries`
--
ALTER TABLE `vListEntries`
  MODIFY `vListActionID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vRequests`
--
ALTER TABLE `vRequests`
  MODIFY `channelRequestID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `vResponses`
--
ALTER TABLE `vResponses`
  MODIFY `channelResponseID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `apiUsers`
  ADD CONSTRAINT `fk_apiUsers_clients1` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `campaign`
--
ALTER TABLE `campaign`
  ADD CONSTRAINT `campaign_ibfk_1` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`),
  ADD CONSTRAINT `campaign_ibfk_2` FOREIGN KEY (`insertedBy`) REFERENCES `users` (`userID`);

--
-- Constraints for table `cCodeEntries`
--
ALTER TABLE `cCodeEntries`
  ADD CONSTRAINT `ccodeentries_ibfk_1` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`),
  ADD CONSTRAINT `ccodeentries_ibfk_2` FOREIGN KEY (`codeID`) REFERENCES `cCodes` (`codeID`),
  ADD CONSTRAINT `ccodeentries_ibfk_3` FOREIGN KEY (`insertedBy`) REFERENCES `users` (`userID`);

--
-- Constraints for table `cCodeEntriesMapping`
--
ALTER TABLE `cCodeEntriesMapping`
  ADD CONSTRAINT `ccodeentriesmapping_ibfk_1` FOREIGN KEY (`cEntryID`) REFERENCES `cEntries` (`entryID`),
  ADD CONSTRAINT `ccodeentriesmapping_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`);

--
-- Constraints for table `cCodes`
--
ALTER TABLE `cCodes`
  ADD CONSTRAINT `ccodes_ibfk_1` FOREIGN KEY (`campaignID`) REFERENCES `campaign` (`campaignID`),
  ADD CONSTRAINT `ccodes_ibfk_2` FOREIGN KEY (`insertedBy`) REFERENCES `users` (`userID`),
  ADD CONSTRAINT `ccodes_ibfk_3` FOREIGN KEY (`updatedBy`) REFERENCES `users` (`userID`),
  ADD CONSTRAINT `ccodes_ibfk_4` FOREIGN KEY (`clientID`) REFERENCES `users` (`userID`);

--
-- Constraints for table `cDrawEntries`
--
ALTER TABLE `cDrawEntries`
  ADD CONSTRAINT `cdrawentries_ibfk_1` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`),
  ADD CONSTRAINT `cdrawentries_ibfk_2` FOREIGN KEY (`cEntryID`) REFERENCES `cEntries` (`entryID`),
  ADD CONSTRAINT `cdrawentries_ibfk_3` FOREIGN KEY (`drawID`) REFERENCES `cDraws` (`drawID`);

--
-- Constraints for table `cDraws`
--
ALTER TABLE `cDraws`
  ADD CONSTRAINT `cdraws_ibfk_1` FOREIGN KEY (`campaignID`) REFERENCES `campaign` (`campaignID`),
  ADD CONSTRAINT `cdraws_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`);

--
-- Constraints for table `cDrawWinners`
--
ALTER TABLE `cDrawWinners`
  ADD CONSTRAINT `cdrawwinners_ibfk_1` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`),
  ADD CONSTRAINT `cdrawwinners_ibfk_2` FOREIGN KEY (`drawID`) REFERENCES `cDraws` (`drawID`);

--
-- Constraints for table `cEntries`
--
ALTER TABLE `cEntries`
  ADD CONSTRAINT `centries_ibfk_1` FOREIGN KEY (`campaignID`) REFERENCES `campaign` (`campaignID`),
  ADD CONSTRAINT `centries_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`);

--
-- Constraints for table `cSettings`
--
ALTER TABLE `cSettings`
  ADD CONSTRAINT `csettings_ibfk_1` FOREIGN KEY (`campaignID`) REFERENCES `campaign` (`campaignID`),
  ADD CONSTRAINT `csettings_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`),
  ADD CONSTRAINT `csettings_ibfk_3` FOREIGN KEY (`ruleID`) REFERENCES `cRules` (`ruleID`);

--
-- Constraints for table `raffleEntries`
--
ALTER TABLE `raffleEntries`
  ADD CONSTRAINT `raffleentries_ibfk_1` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`),
  ADD CONSTRAINT `raffleentries_ibfk_2` FOREIGN KEY (`campaignID`) REFERENCES `campaign` (`campaignID`);

--
-- Constraints for table `raffleOrders`
--
ALTER TABLE `raffleOrders`
  ADD CONSTRAINT `raffleorders_ibfk_1` FOREIGN KEY (`campaignID`) REFERENCES `campaign` (`campaignID`),
  ADD CONSTRAINT `raffleorders_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`);

--
-- Constraints for table `raffleOrderTickets`
--
ALTER TABLE `raffleOrderTickets`
  ADD CONSTRAINT `raffleordertickets_ibfk_1` FOREIGN KEY (`campaignID`) REFERENCES `campaign` (`campaignID`),
  ADD CONSTRAINT `raffleordertickets_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`),
  ADD CONSTRAINT `raffleordertickets_ibfk_3` FOREIGN KEY (`orderID`) REFERENCES `raffleOrders` (`orderID`);
COMMIT;
