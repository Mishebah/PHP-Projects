...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2019 at 08:57 AM
...
--
-- Constraints for table `campaignRequests`
--
ALTER TABLE `campaignRequests`
  ADD CONSTRAINT `campaignrequests_ibfk_1` FOREIGN KEY (`campaignID`) REFERENCES `campaign` (`campaignID`);
...
--
-- Constraints for table `sourceAddressMapping`
--
ALTER TABLE `sourceAddressMapping`
  ADD CONSTRAINT `sourceaddressmapping_ibfk_1` FOREIGN KEY (`sourceAddressID`) REFERENCES `mverify`.`sourceAddresses` (`sourceAddressID`),
  ADD CONSTRAINT `sourceaddressmapping_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `clients` (`clientID`);

--
-- Constraints for table `vListEntries`
--
ALTER TABLE `vListEntries`
  ADD CONSTRAINT `vlistentries_ibfk_2` FOREIGN KEY (`insertedBy`) REFERENCES `users` (`userID`),
  ADD CONSTRAINT `vlistentries_ibfk_3` FOREIGN KEY (`updatedBy`) REFERENCES `users` (`userID`),
  ADD CONSTRAINT `vlistentries_ibfk_4` FOREIGN KEY (`vListID`) REFERENCES `mverify`.`vList` (`vListID`);
COMMIT;
